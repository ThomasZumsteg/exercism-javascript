...
describe('Transpose', function () {
  ...
  it('test two characters in a column', function () {
    var input = ['A', '1'];
    var expected = ['A1'];
    expect(transpose(input)).toEqual(expected);
  });
  ...
  it('test second line longer than first line', function () {
